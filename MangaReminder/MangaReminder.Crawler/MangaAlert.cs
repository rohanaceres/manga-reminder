...
namespace MangaReminder.Crawler
{
    public sealed class MangaAlert
    {
        ...
        public void SendIt (Manga manga)
        {
            ...
            MailMessage mailMessage = new MailMessage(LoginConfigs.Username, this.TargetMail, "Nova edição - " + manga.Name, this.GetMailBody(manga));

            // Instancia o cliente SMTP para envio de email e suas propriedades
            SmtpClient client = new SmtpClient("smtp.gmail.com");
            client.Port = 587;
            client.EnableSsl = true;
            client.Credentials = new System.Net.NetworkCredential("rohanaceres@gmail.com", "Senha123!");
